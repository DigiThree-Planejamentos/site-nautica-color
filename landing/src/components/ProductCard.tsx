...
export function ProductCard({
  ...
  return (
    <article className="group flex h-full flex-col rounded-[28px] border border-navy/10 bg-white p-3 shadow-sm transition hover:-translate-y-1 hover:border-red/20 hover:shadow-soft">
      <div className="relative block overflow-hidden rounded-3xl bg-sky p-6 transition group-hover:bg-mist">
      ...
      <div className="mt-4 flex flex-1 flex-col px-2">
        ...
        <h3 className="mt-1.5 font-heading text-lg font-bold leading-tight text-navy">{product.name}</h3>
        ...
        <a
          ...
          className="mt-4 flex h-11 w-full items-center justify-center gap-2 rounded-full bg-red text-sm font-semibold text-white transition hover:bg-red-bright"
        >
