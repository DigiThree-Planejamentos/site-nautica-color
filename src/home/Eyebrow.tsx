...
/**
 * Rótulo padrão acima dos títulos de seção. Mantém a hierarquia consistente
 * em toda a home com uma pequena barra de acento.
 * - `tone="red"` para fundos claros, `tone="light"` para fundos navy.
 *
 * Cópia exclusiva da HOME (rota /). Editar aqui não afeta a landing (/lp)
 * nem o catálogo (/produtos), que têm suas próprias versões.
 */
