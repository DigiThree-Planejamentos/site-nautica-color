...
import { CategoryTable } from "@/home/CategoryTable";
import { HeroSearch } from "@/home/HeroSearch";
import { HeroWave } from "@/home/HeroWave";
import { StoreExperience } from "@/home/StoreExperience";
 ...
 * HOME DO SITE — rota /.
 *
 * Página totalmente isolada da landing (/lp): todos os componentes que ela usa
 * vivem em src/home/. Mexer aqui ou em src/home/ NÃO altera a landing, e mexer
 * na landing (src/landing/) NÃO altera a home. Só compartilham a infraestrutura
 * de dados/carrinho (lib, types, CartStepper), também usada pelo catálogo.
 */
