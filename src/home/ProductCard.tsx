...
/**
 * Cartão de produto exclusivo da HOME (rota /). Editar aqui não afeta a landing
 * (/lp) nem o catálogo (/produtos), que têm suas próprias versões. Usa o
 * CartStepper compartilhado (sistema de carrinho) e os utilitários de dados.
 */
