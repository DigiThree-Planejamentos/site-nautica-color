    ...
    <main>
      <section className="bg-navy py-14 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="mt-3 font-heading text-5xl font-extrabold">Produtos para orçamento</h1>
          <p className="mt-4 max-w-2xl text-white/75">Pesquise, filtre e monte sua lista. Preço, estoque e condições serão confirmados pela equipe.</p>
        </div>
      </section>
